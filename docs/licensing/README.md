...
本フォルダには、ライセンスパック販売、請求書払い、法的検討に関するドキュメントを格納しています。
...
- `docs/enterprise/license-key-purchase-guide.md` - エンタープライズ向け購入ガイド
- `docs/testing/license-testing-guide.md` - ライセンス機能のテスト手順
- `src/PdfHandler.UI/Resources/Legal/TERMS_OF_USE.txt` - 利用規約（第12条に有償ライセンス条項を追加済み）
